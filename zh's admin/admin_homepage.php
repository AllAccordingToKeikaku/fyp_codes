                    ...
                    <div id="createUserAccountDisplay" style="display:none;width:600px;">
                        ...
                        <div id="createAccount" style="font-size:20px;display:block">
                            ...
                            <div id="miscType" style="display:none">
                                <label style="width:auto;display:inline-block">Email: </label><input type="text" id="createAccountEmail" style="margin-top:5px;margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter email address" 
                                name="input_email1"></br></br>

                                <label style="width:auto;display:inline-block">Password: </label><input type="text" id="createAccountPassword" style="margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter password"
                                name="input_password1"></br></br>

                                <label style="width:auto;display:inline-block">Description: </label><input type="text" id="createAccountDescription" style="margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter description"
                                name="input_description1"></br></br>

                                <input type="submit" class="buttonHoverEffect" style="display:inline-block;width:485px;height:40px;cursor:pointer;background-color:#5BBDE4CC;border-radius:10px" value="Create profile" onclick="createMiscAccount()" 
                                name="create1">
                            </div>
                            <div id="customerType" style="display:none">
                                <label style="width:auto;display:inline-block">Full name: </label><input type="text" id="createAccountName" style="margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter full name"
                                name="input_fullname2"></br></br>

                                <label style="width:auto;display:inline-block">Email: </label><input type="text" id="createAccountEmail" style="margin-top:5px;margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter email address"
                                name="input_email2"></br></br>

                                <label style="width:auto;display:inline-block">Password: </label><input type="text" id="createAccountPassword" style="margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter password"
                                name="input_password2"></br></br>

                                <label style="width:auto;display:inline-block">Phone number: </label><input type="text" id="createAccountNumber" style="margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter phone number"
                                name="input_phone2"></br></br>

                                <label style="width:auto;display:inline-block">Description: </label><input type="text" id="createAccountDescription" style="margin-left:30px;width:300px;background-color:#A8A1A166;border:none;border-radius:5px;font-size:20px" placeholder="Enter description"
                                name="input_description2"></br></br>

                                <input type="submit" class="buttonHoverEffect" style="display:inline-block;width:485px;height:40px;cursor:pointer;background-color:#5BBDE4CC;border-radius:10px" value="Create profile" onclick="createCustomerAccount()"
                                name="create2">
                            </div>
                        </div></br>
                    </div>
